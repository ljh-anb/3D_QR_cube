...
if pred_type == 1 :
    ...
    confus_name = 'RF_confusion_matrix_side_LP_ext'
    if external == 0:
        array_name = 'RF_array_pred_side_LP'
    else:
        array_name = 'RF_array_pred_side_LP_ext'
elif pred_type == 2:
    model_name = 'RF_trained_model_LP'
    confus_name = 'RF_confusion_matrix_LP_ext'
    if external ==0:
        array_name = 'RF_array_pred_LP'
    else:
        array_name = 'RF_array_pred_LP_ext'
#------------------------------------------------------------------
